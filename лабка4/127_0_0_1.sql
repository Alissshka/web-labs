...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 19 2024 г., 09:29
...
('root', '2024-12-19 08:26:20', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ru\"}');
...
--
CREATE DATABASE IF NOT EXISTS `выставка` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `выставка`;
...
--
ALTER TABLE `помещения`
  MODIFY `ID_Помещения` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `посетители`
--
ALTER TABLE `посетители`
  MODIFY `ID_Посетителя` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `расписание_экскурсии`
--
ALTER TABLE `расписание_экскурсии`
  MODIFY `ID_Расписания` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `стендисты`
--
ALTER TABLE `стендисты`
  MODIFY `ID_Стендиста` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `стенды`
--
ALTER TABLE `стенды`
  MODIFY `ID_Стенда` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `экскурсии`
--
ALTER TABLE `экскурсии`
  MODIFY `ID_Экскурсии` int(11) NOT NULL AUTO_INCREMENT;
